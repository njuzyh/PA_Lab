...
static void instr_execute_2op() {
	...
	//else opr_dest.val = alu_and(opr_src.val,  opr_dest.val);
	opr_dest.val = alu_and(sign_ext(opr_src.val, opr_src.data_size),  sign_ext(opr_dest.val, opr_dest.data_size));
